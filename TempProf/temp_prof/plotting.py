...
def plot_profs_inout_dist(dToT_input, dToT_outputs_reshape, tp_vals, yvals, xi_vals, chi2_vals, fname=None, show=True, cmap_num=0, interpolation='antialiased'):
...
def plot_profs_out(dToT_outputs_reshape, tp_vals, yvals, xi_vals, chi2_vals, fname=None, show=True, cmap_num=0, interval=50, 
                   Ncol=4, interpolation='antialiased'):
